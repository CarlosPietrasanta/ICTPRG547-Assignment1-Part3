    ...
    public class BinarySearchTests
    {
       ...
       [SetUp]
        ...
        public void TestStudentFound()
        {
            ...
            int existingStudentIndexLinearSearch = UtilityClass.BinarySearchArray(studentArray, existingStudent);

            Assert.That(existingStudentIndexLinearSearch == 2);
        }

        [Test]
        public void TestStudentNotFound()
        {
            int nonExistingStudentIndexLinearSearch = UtilityClass.BinarySearchArray(studentArray, nonExistingStudent);
